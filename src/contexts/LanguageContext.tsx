...
export const optionListKeys = {
  designCategories: ["bracelet", "beaded_bracelet", "necklace", "ring", "earrings"],
  overallDesignStyles: ["minimalist", "bohemian", "vintage", "modernGeometric", "artDeco", "natureInspired", "celestial", "zen", "gothic", "healing", "spiritual", "elegant", "nordic", "contemporary", "magical", "rustic", "artNouveau"],
  ...
  structureOptionsBracelet: ["single_strand", "multi_strand", "pendant_focus", "beaded_chain", "layered", "charm_bracelet"],
  structureOptionsBeadedBracelet: ["uniform_beads", "alternating_pattern", "focal_center", "graduated_size", "spacer_separated", "prayer_mala"],
  structureOptionsNecklace: ["single_strand", "multi_strand", "pendant_focus", "beaded_chain", "layered", "lariat", "choker"],
  structureOptionsRing: ["solitaire_band", "eternity_band", "three_stone", "halo_setting", "cluster_ring", "signet_ring", "bezel_setting"],
  structureOptionsEarrings: ["stud", "dangle_drop", "hoop", "cluster_earring", "chandelier", "ear_climber"],
  
  beadworkDensities: ["compact", "spaced_out"],
  focalPoints: ["central_stone", "asymmetrical_accent", "no_focal_point"],
  
  metalTypes: ["gold", "silver", "rose_gold", "platinum", "bronze", "copper"],
  ...
  themes: ["diamond-platinum", "black-gold", "rose-gold", "emerald", "sapphire"],
  applicationPlatforms: ["flux", "turbo", "openai", "stable-diffusion", "midjourney", "dalle", "local-comfyui", "local-automatic1111", "local-invokeai", "custom"],
  photographyAspectRatios: ["ratio_1_1", "ratio_4_5", "ratio_3_4", "ratio_2_3", "ratio_16_9", "ratio_9_16"],
};
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    let initialThemeOnClient: Theme = 'aura';
    if (storedTheme && storedTheme === 'aura') {
