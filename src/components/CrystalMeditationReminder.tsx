...
import { Bell, Play, Pause, Square, RotateCcw, Timer, Gem, Sparkles, Heart, CheckCircle, Calendar, Settings, Volume2, VolumeX, Sunrise, Sun, Sunset, Moon, Music, Headphones, Waves, Zap } from 'lucide-react';
...
interface AudioRecommendation {
  ...
  description: string;
  frequency?: string; // 如 "528Hz", "432Hz"
  duration: string; // 如 "10分钟", "循环播放"
  benefits: string[];
  chakraAlignment?: string;
  url?: string; // 实际项目中的音频链接
  preview?: string; // 预览描述
}
...
// 音频推荐数据库
const AUDIO_RECOMMENDATIONS: AudioRecommendation[] = [
  {
    id: 'solfeggio-528',
    name: '528Hz DNA修复频率',
    type: 'frequency',
  ...
  },
  {
    ...
    name: '七脉轮水晶钵音疗',
    type: 'crystal_bowl',
    description: '完整的七脉轮水晶唱钵序列，平衡全身能量',
    duration: '21分钟',
  ...
  },
  {
    ...
    name: 'Theta脑波双耳节拍',
    type: 'binaural',
    description: '4-8Hz Theta波，引导进入深度冥想状态',
    frequency: '6Hz',
    duration: '30分钟',
    benefits: ['深度冥想', '直觉开发', '创造力提升', '潜意识疗愈'],
    chakraAlignment: 'thirdEye',
    preview: '左耳440Hz，右耳446Hz，产生6Hz差频'
  },
  {
    id: 'ocean-waves',
    name: '海洋波浪自然音',
...
const MEDITATION_TYPES: MeditationType[] = [
  {
    ...
    frequency: 'daily',
    recommendedAudio: [
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'solfeggio-432')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'crystal-bowl-set')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'ambient-space')!
    ]
  },
  {
    id: 'heart-healing',
    ...
    frequency: 'weekly',
    recommendedAudio: [
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'solfeggio-528')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'crystal-bowl-set')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'ocean-waves')!
    ]
  },
  {
    ...
    frequency: 'custom',
    recommendedAudio: [
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'forest-rain')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'solfeggio-432')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'ocean-waves')!
    ]
  },
  {
    ...
    frequency: 'weekly',
    recommendedAudio: [
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'theta-binaural')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'ambient-space')!,
      AUDIO_RECOMMENDATIONS.find(a => a.id === 'crystal-bowl-set')!
    ]
  }
