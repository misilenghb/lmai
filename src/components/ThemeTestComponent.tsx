...
import { Diamond, Crown, Heart, Gem, Sparkles, Palette, Type, Eye } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      <Card className="aura-card aura-glow">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 aura-text-gradient">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-primary/10 rounded-lg aura-sparkle">
              <div className="w-12 h-12 mx-auto mb-2 bg-primary rounded-full aura-pulse"></div>
              <h3 className="font-semibold">主色调</h3>
              <p className="text-sm text-muted-foreground">AURA粉红</p>
            </div>
            <div className="text-center p-4 bg-secondary/10 rounded-lg aura-sparkle">
              <div className="w-12 h-12 mx-auto mb-2 bg-secondary rounded-full aura-pulse"></div>
              <h3 className="font-semibold">次要色调</h3>
              <p className="text-sm text-muted-foreground">AURA紫色</p>
            </div>
            <div className="text-center p-4 bg-accent/10 rounded-lg aura-sparkle">
              <div className="w-12 h-12 mx-auto mb-2 bg-accent rounded-full aura-pulse"></div>
              <h3 className="font-semibold">强调色调</h3>
              <p className="text-sm text-muted-foreground">AURA蓝色</p>
            </div>
          </div>

          <div className="text-center">
            <Badge variant="secondary" className="aura-border aura-glow">
              当前主题: AURA
            </Badge>
          </div>
        </CardContent>
