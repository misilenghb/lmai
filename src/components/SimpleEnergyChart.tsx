        ...
        <Tabs defaultValue="chart" className="w-full">
                    ...
                    <div className="h-8 bg-muted rounded-full overflow-hidden">
                      <div
                        className={`h-full transition-all duration-500 ${
                          item.energyLevel >= 4 ? 'bg-gradient-to-r from-success to-success/80' :
                          item.energyLevel >= 3 ? 'bg-gradient-to-r from-primary to-primary/80' :
                          item.energyLevel >= 2 ? 'bg-gradient-to-r from-warning to-warning/80' :
            ...
            <div className="space-y-3">
              {insights.map((insight, index) => (
                <Card key={index} className={`border-l-4 ${
                  insight.type === 'positive' ? 'border-l-success bg-success/5' :
          ...
          <TabsContent value="details" className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Card>
                <CardContent className="p-4 text-center">
                  <div className="text-2xl font-bold text-primary">{averageEnergy.toFixed(1)}/5</div>
                  <div className="text-xs text-muted-foreground">平均能量</div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4 text-center">
                  <div className="text-2xl font-bold text-success">{maxEnergy}/5</div>
                  <div className="text-xs text-muted-foreground">最高能量</div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4 text-center">
                  <div className="text-2xl font-bold text-destructive">{minEnergy}/5</div>
