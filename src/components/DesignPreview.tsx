...
import { Loader2, AlertCircle, Download, Share2, Save, MoreHorizontal, Send, Copy, RefreshCw } from 'lucide-react';
                   ...
                   <div className="flex-shrink-0 p-4 bg-background border-t space-y-4">
                       ...
                       <div className="grid grid-cols-2 gap-2">
                          <Button variant="outline" onClick={handleGenerateVariations}>
                            <Copy className="mr-2"/>
                            {t('designPreview.variationsButton')}
                          </Button>
                          <Button variant="outline" onClick={() => handleEnhanceImage(selectedImage)}>
                            <LuxuryIcons.Crystal
                              size={16}
                            ...
                            />
                            <span className="ml-2">{t('designPreview.enhanceButton')}</span>
                          </Button>
                       </div>
