        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-1">
              {metrics.trend === 'up' && <TrendingUp className="h-4 w-4 text-success" />}
              {metrics.trend === 'down' && <TrendingDown className="h-4 w-4 text-destructive" />}
              {metrics.trend === 'stable' && <Minus className="h-4 w-4 text-muted-foreground" />}
            ...
            <div key={index} className="text-center p-1">
              ...
              <div 
                className={`w-6 h-6 mx-auto mt-1 rounded-full flex items-center justify-center text-white text-xs ${
                  item.energyLevel >= 4 ? 'bg-success' :
                  item.energyLevel >= 3 ? 'bg-primary' :
                  'bg-warning'
                }`}
              >
